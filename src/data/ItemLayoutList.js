...
const trackerLayoutList = {
  ...
  icon_library: {
    ...
    layout: [
      "BLANK", "OOT_FOREST_MEDALLION", "OOT_FIRE_MEDALLION", "OOT_WATER_MEDALLION", "OOT_SHADOW_MEDALLION", "OOT_SPIRIT_MEDALLION", "OOT_LIGHT_MEDALLION", "OOT_KOKIRI_EMERALD",
      ...
      "OOT_KOKIRI_SWORD", "OOT_MASTER_SWORD", "OOT_GORON_TUNIC", "OOT_ZORA_TUNIC", "OOT_IRON_BOOTS", "OOT_HOVER_BOOTS", "OOT_ZELDAS_LULLABY",
      "OOT_EPONAS_SONG", "OOT_SARIAS_SONG", "OOT_SUNS_SONG", "OOT_SONG_OF_TIME", "OOT_SONG_OF_STORMS", "OOT_MINUET", "OOT_BOLERO", "OOT_SERENADE", "OOT_NOCTURNE",
      "OOT_REQUIEM", "OOT_PRELUDE", "MM_ODOLWAS_REMAINS", "MM_GOHTS_REMAINS", "MM_GYORGS_REMAINS", "MM_TWINMOLDS_REMAINS",
