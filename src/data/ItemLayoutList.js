  ...
  ootmm_wide: {
    ...
    layout: [
      ...
      "OOT_FOREST_MEDALLION_LABELED", "OOT_FIRE_MEDALLION_LABELED", "OOT_WATER_MEDALLION_LABELED", "OOT_PROGRESSIVE_STRENGTH", "OOT_BOMB_BAG",
        "OOT_MIRROR_SHIELD", "MM_DEKU_MASK", "MM_GORON_MASK_WKEG", "MM_ZORA_MASK", "MM_FIERCE_DEITY_MASK",
      "OOT_SHADOW_MEDALLION_LABELED", "OOT_SPIRIT_MEDALLION_LABELED", "OOT_LIGHT_MEDALLION_LABELED", "OOT_BOTTLE_RUTOS", "OOT_BOOMERANG",
        "OOT_GO_MODE", "MM_BOW", { type: "3x3grid", items: ["MM_FIRE_ARROWS", "MM_ICE_ARROWS", "MM_LIGHT_ARROWS"], size: 1 }, "MM_MAGIC_WLENS", "MM_BOTTLE",
      "OOT_MAGIC_WLENS", "OOT_BOW", "OOT_COMPOSITE_ARROWS", "OOT_COMPOSITE_SPELLS", "OOT_COMPOSITE_BOOTS",
        "MM_GO_MODE", defCT("MM_OATH_TO_ORDER"), "MM_PROGRESSIVE_EXPLOSIVES", "MM_COMPOSITE_IKANA_ACCESS", "MM_HOOKSHOT",
      defCT("OOT_ZELDAS_LULLABY"), defCT("OOT_EPONAS_SONG"), defCT("OOT_SONG_OF_STORMS"), defCT("OOT_NOCTURNE"), defCT("OOT_REQUIEM"),
        defCT("MM_EPONAS_SONG"), defCT("MM_SONATA_OF_AWAKENING"), defCT("MM_GORON_LULLABY"), defCT("MM_NEW_WAVE_BOSSA_NOVA"), defCT("MM_ELEGY_OF_EMPTINESS")
    ]
  }
}
